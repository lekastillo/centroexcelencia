...
class JSNTplWidgetUpgrade extends JSNTplWidgetBase
{
	...
	public function replaceAction ()
	{
		...
		$manifestContent = JFile::read(JPATH_ROOT . "/templates/{$this->template['name']}/templateDetails.xml");
		$manifestContent = str_replace('<edition>STANDARD</edition>', '<edition>UNLIMITED</edition>', $manifestContent);

		// Write manifest content
		JFile::write(JPATH_ROOT . "/templates/{$this->template['name']}/templateDetails.xml", $manifestContent);
	}
