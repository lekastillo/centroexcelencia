...
abstract class JSNHtmlAsset
{
	...
	public static function buildHeader ()
	{
		...
		$html = "
			...
			<script type=\"text/javascript\">
				...
				define('jquery', typeof(jQuery) == 'undefined' ? [JSNEnv.rootUrl + '/media/jui/js/jquery.min.js'] : [], function () {
	...
	/**
	 * This method return true if an array use number system to index
	 * values
	 *
	...
	/**
	 * Load jquery lib
	 * just use for JSN_IMAGESHOW temporarilly
	 *
