...
class JFormFieldTextLimit extends JSNFormField
{
	...
	protected function getInput()
	{
		...
		// Generate HTML
		$html	= '<input type="number" value="' . (int) $value . '" class="jsn-input-mini-fluid" onchange="var field = this.form.querySelector(\'#' . $this->id . '\'); field.value = field.value.replace(/^[\d\s]*/, this.value);" />&nbsp;'
