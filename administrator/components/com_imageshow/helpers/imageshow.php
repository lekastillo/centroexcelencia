...
class JSNISImageShowHelper
{
	...
	{	
		...
		// Declare 2nd-level menu items	for 'items' entry
		JSNMenuHelper::addEntry(
			'all-showlists', 'All Showlists', 'index.php?option=com_imageshow&view=showlist', false, '', 'sub-menu.showlists'
		);
		
		JSNMenuHelper::addEntry(
			'all-showcases', 'All Showcases', 'index.php?option=com_imageshow&view=showcase', false, '', 'sub-menu.showcases'
		);
		...
		{
			JSNMenuHelper::addEntry(
				'recent-showlist', 'Recent Showlists', '', false, '', 'sub-menu.showlists'
			);
		...
		{
			JSNMenuHelper::addEntry(
				'recent-showcase', 'Recent Showcases', '', false, '', 'sub-menu.showcases'
			);
		...
		JSNMenuHelper::addEntry(
			'showlist-new', 'Create new showlist', 'index.php?option=com_imageshow&controller=showlist&task=add', false, '', 'sub-menu.showlists'
		);
		
		JSNMenuHelper::addEntry(
			'showcase-new', 'Create new showcase', 'index.php?option=com_imageshow&controller=showcase&task=add', false, '', 'sub-menu.showcases'
		);
