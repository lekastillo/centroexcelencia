				...
				if (!empty($formId))
				{
						...
						echo JSNUniformHelper::generateStylePages($formStyleCustom,
							...
							"#jsn_form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group.error .help-block,\n" .
								"#form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group.error .help-inline,\n" .
								"#form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group.error .help-block span.label",
							"#jsn_form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group .label-important,\n" .
								"#form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group .label-important .badge-important",
							"#form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group .controls input,\n" .
								"#form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group .controls select,\n" .
								"#form_{$formId}.jsn-master .jsn-bootstrap  .jsn-form-content .control-group .controls textarea"
						);
				}
				exit();
		}
