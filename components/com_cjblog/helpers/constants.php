...
defined('CJBLOG_VERSION') or define('CJBLOG_VERSION', '1.1.3');

defined('CJBLOG_MEDIA_DIR') or define('CJBLOG_MEDIA_DIR',					JPATH_ROOT.DS.'media'.DS.CJBLOG.DS);
defined('CJBLOG_MEDIA_URI') or define('CJBLOG_MEDIA_URI',					JURI::root(true).'/media/'.CJBLOG.'/');
defined('CJBLOG_BADGES_BASE_DIR') or define('CJBLOG_BADGES_BASE_DIR',		JPATH_ROOT.DS.'images'.DS.'badges'.DS);
defined('CJBLOG_BADGES_BASE_URI') or define('CJBLOG_BADGES_BASE_URI',		JURI::root(true).'/images/badges/');
defined('CJBLOG_AVATAR_BASE_DIR') or define('CJBLOG_AVATAR_BASE_DIR',		JPATH_ROOT.DS.'images'.DS.'avatar'.DS);
defined('CJBLOG_AVATAR_BASE_URI') or define('CJBLOG_AVATAR_BASE_URI',		JURI::root(true).'/images/avatar/');
defined('CJBLOG_PLUGINS_BASE_DIR') or define('CJBLOG_PLUGINS_BASE_DIR',		JPATH_ROOT.DS.'media'.DS.'cjblog'.DS.'plugins'.DS);
