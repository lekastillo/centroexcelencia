			...
			<div class="span12">
		    	...
		    	<div class="accordion" id="sub-categories">
		    		<div class="accordion-group">
		    			<div class="accordion-heading">
		    				...
		    				<a href="<?php echo JRoute::_('index.php?option='.CJBLOG.'&view=form'.$cat_alias.$form_itemid)?>" class="pull-right accordion-toggle">
		    					<strong><i class="icon-edit"></i> <?php echo JText::_('LBL_SUBMIT_ARTICLE');?></strong>
		    				</a>
		    				<?php else:?>
		    				<a href="<?php echo JRoute::_('index.php?option=com_content'.$jform_itemid);?>" class="pull-right accordion-toggle">
		    					<strong><i class="icon-edit"></i> <?php echo JText::_('LBL_SUBMIT_ARTICLE');?></strong>
		    				</a>
		    				<?php endif;?>
		    				<?php endif;?>
		    	...
		    	<div class="accordion" id="sub-categories">
		    		<div class="accordion-group">
		    			<div class="accordion-heading">
		    				<?php if($this->params->get('form_handler', 'cjblog') == 'cjblog'):?>
		    				<a href="<?php echo JRoute::_('index.php?option='.CJBLOG.'&view=form'.$cat_alias.$form_itemid)?>" class="accordion-toggle">
		    					<strong><i class="icon-edit"></i> <?php echo JText::_('LBL_SUBMIT_ARTICLE');?></strong>
		    				</a>
		    				<?php else:?>
		    	...
		    	<div class="article-block padbottom-20 clearfix">
		    		...
		    		<div class="<?php echo $this->params->get('thumbnail_size') == 0 ? 'span2' : 'span3';?>">
		    			<a class="thumbnail" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->id.':'.$article->alias, $article->catid.':'.$article->category_alias));?>">
		    				<img src="<?php echo CjBlogHelper::get_first_image($article->introtext.$article->fulltext, ($this->params->get('thumbnail_size') == 0 ? 96 : 160));?>">
		    			</a>
		    		</div>
		    		<?php endif;?>
							...
							<small class="align-middle">
								...
								if($this->params->get('show_author')){
									...
									if($this->params->get('link_author')){
										...
										echo JText::sprintf('TXT_WRITTEN_BY', CJFunctions::get_user_profile_link($this->params->get('user_avatar', 'cjblog'), $article->created_by, $this->escape($article->display_name) )).' ';
									} else {
