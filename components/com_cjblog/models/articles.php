...
class CjBlogModelArticles extends JModelLegacy {
	...
	function get_articles($options = array()){
		...
		$query = '
			select
				a.id, a.title, a.alias, a.catid, a.created_by, a.created, a.checked_out, a.checked_out_time, a.hits, a.introtext, a.fulltext,
	...
	function get_article($id = null){
		...
		$query = '
			select
				a.id, a.title, a.alias, a.title_alias, a.introtext, a.introtext as articletext, a.fulltext, 
