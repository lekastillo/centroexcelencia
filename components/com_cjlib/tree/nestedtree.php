...
class CjNestedTree
{
     ...
     *  @return void
     */
    function CjNestedTree($db, $table_name, $extra_columns=array(), $id_column = 'id', $title_column = 'title', $left_column = 'nleft', $right_column = 'nright', $parent_column = 'parent_id') {
    ...
    private function _rebuild_tree($parent, $left){
    	...
    	$this->properties['database']->setQuery($query);
    	$nodes = APP_VERSION == '1.5' ? $this->properties['database']->loadResultArray() : $this->properties['database']->loadColumn();
